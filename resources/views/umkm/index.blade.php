    ...
    <div class="bg-green-600 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">UMKM</h1>
                <p class="text-xl opacity-90">Usaha Mikro Kecil Menengah Nagari Pematang Panjang</p>
            </div>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    @foreach ($umkms as $umkm)
                        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border">
                            ...
                            @endif
                            <div class="p-6">
                                <h3 class="text-xl font-semibold text-gray-900 mb-2">{{ $umkm->nama }}</h3>
                                <p class="text-gray-600 mb-4 line-clamp-3">{{ $umkm->deskripsi }}</p>
                                    ...
                                    <div class="flex space-x-2">
                                        @if ($umkm->whatsapp)
                                            <a href="https://wa.me/{{ $umkm->whatsapp }}" target="_blank"
                                                class="text-green-500 hover:text-green-600 p-2 rounded-full bg-green-50 hover:bg-green-100 transition-colors">
                                        ...
                                        @if ($umkm->instagram)
                                            <a href="{{ $umkm->instagram }}" target="_blank"
                                                class="text-pink-500 hover:text-pink-600 p-2 rounded-full bg-pink-50 hover:bg-pink-100 transition-colors">
                                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                                    <path
