    ...
    <div class="bg-green-600 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Artikel & <span
                        class="text-yellow-300">Berita</span></h1>
            ...
            @if ($articles->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach ($articles as $article)
                        <article
                            class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border-b-4 border-transparent hover:border-yellow-400">
                            @if ($article->gambar)
                            ...
                            <div class="p-6">
                                <div class="flex items-center text-sm text-gray-500 mb-3">
                                    <span
                                        class="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs font-medium uppercase mr-2">
                                        {{ $article->kategori }}
                                        </span>
                                ...
                                <h3
                                    ...
                                    <a
                                        href="{{ route('articles.show', $article->slug) }}" class="hover:text-green-600">
                                        {{ $article->judul }}
                                        </a>
                                    </h3>
